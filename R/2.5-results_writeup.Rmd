...
. Critically, the effects of automation condition and automation success interacted, 
...
but on trials where the automation failed, it imposed a substantial cost to their accuracy (misuse).
Importantly, accuracy on automation failure trials was far from floor, suggesting
